              ...
              return (
                <div key={step} className="flex items-center gap-3 sm:gap-4 shrink-0 first:ml-2 last:mr-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {/* Circle */}
                    <div
                      className={`w-8 h-8 sm:w-10 sm:h-10 shrink-0 rounded-full flex justify-center items-center font-heading font-semibold text-xs sm:text-sm transition-all duration-500 ease-out ${isActive
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <span
                          className={`font-body text-xs sm:text-sm tracking-wide transition-colors duration-300 leading-tight whitespace-nowrap max-w-[80px] sm:max-w-[120px] lg:max-w-[160px] truncate cursor-[inherit] ${isActive
